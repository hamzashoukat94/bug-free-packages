...
class BodyParamsControllerTests(ControllerTestBase):
    ...
    # Todo: Add description for test test_rfc_1123_date_time_in_body_as_model
    def test_rfc_1123_date_time_in_body_as_model(self):
        # Parameters for the API call
        body = APIHelper.json_deserialize('{"dateTime":"Sun, 06 Nov 1994 08:49:37 GMT"}', Rfc1123DateTime.from_dictionary)

        # Perform the API call through the SDK function
        result = self.controller.create_send_rfc_1123_date_time_in_body_as_model(body)

        # Test response code
        assert self.response_catcher.response.status_code == 200

    # Todo: Add description for test test_rfc_3339_date_time_in_body_as_model
    def test_rfc_3339_date_time_in_body_as_model(self):
        # Parameters for the API call
        data = APIHelper.json_deserialize('{"dateTime":"1994-02-13T14:01:54.9571247Z"}', DateTimeModel.from_dictionary)

        # Perform the API call through the SDK function
        result = self.controller.create_send_rfc_3339_date_time_in_body_as_model(data)
    ...
    # Todo: Add description for test test_send_unix_date_time_in_body_as_model
    def test_send_unix_date_time_in_body_as_model(self):
        # Parameters for the API call
        body = APIHelper.json_deserialize('{"dateTime":1484719381}', UnixDateTime.from_dictionary)

        # Perform the API call through the SDK function
        result = self.controller.create_send_unix_date_time_in_body_as_model(body)

        # Test response code
        assert self.response_catcher.response.status_code == 200

    # Todo: Add description for test test_rfc_3339_date_time_array_in_body_as_model
    def test_rfc_3339_date_time_array_in_body_as_model(self):
        # Parameters for the API call
        data = APIHelper.json_deserialize('{"dateTime":["1994-02-13T14:01:54.9571247Z","1994-02-13T14:01:54.9'
            '571247Z"]}', Rfc3339DateTimeArray.from_dictionary)

        # Perform the API call through the SDK function
        result = self.controller.create_send_rfc_3339_date_time_array_in_body_as_model(data)

        # Test response code
        assert self.response_catcher.response.status_code == 200

    # Todo: Add description for test test_unix_date_time_array_in_body_as_model
    def test_unix_date_time_array_in_body_as_model(self):
        # Parameters for the API call
        data = APIHelper.json_deserialize('{"dateTime":[1484719381,1484719381]}', UnixDateTimeArray.from_dictionary)

        # Perform the API call through the SDK function
        result = self.controller.create_send_unix_date_time_array_in_body_as_model(data)

        # Test response code
        assert self.response_catcher.response.status_code == 200

    # Todo: Add description for test test_rfc_3339_date_time_map_in_body_as_model
    def test_rfc_3339_date_time_map_in_body_as_model(self):
        # Parameters for the API call
        data = APIHelper.json_deserialize('{"dateTime":{"key":"1994-02-13T14:01:54.9571247Z"}}', Rfc3339DateTimeMap.from_dictionary)

        # Perform the API call through the SDK function
        result = self.controller.create_send_rfc_3339_date_time_map_in_body_as_model(data)

        # Test response code
        assert self.response_catcher.response.status_code == 200

    # Todo: Add description for test test_rfc_1123_date_time_map_in_body_as_model
    def test_rfc_1123_date_time_map_in_body_as_model(self):
        # Parameters for the API call
        data = APIHelper.json_deserialize('{"dateTime":{"key":"Sun, 06 Nov 1994 08:49:37 GMT"}}', Rfc1123DateTimeMap.from_dictionary)

        # Perform the API call through the SDK function
        result = self.controller.create_send_rfc_1123_date_time_map_in_body_as_model(data)

        # Test response code
        assert self.response_catcher.response.status_code == 200

    # Todo: Add description for test test_unix_date_time_map_in_body_as_model
    def test_unix_date_time_map_in_body_as_model(self):
        # Parameters for the API call
        data = APIHelper.json_deserialize('{"dateTime":{"key":1484719381}}', UnixDateTimeMap.from_dictionary)

        # Perform the API call through the SDK function
        result = self.controller.create_send_unix_date_time_map_in_body_as_model(data)

        # Test response code
        assert self.response_catcher.response.status_code == 200

    # Todo: Add description for test test_rfc_1123_date_time_array_in_body_as_model
    def test_rfc_1123_date_time_array_in_body_as_model(self):
        # Parameters for the API call
        data = APIHelper.json_deserialize('{"dateTime":["Sun, 06 Nov 1994 08:49:37 GMT","Sun, 06 Nov 1994 08:'
            '49:37 GMT"]}', Rfc1123DateTimeArray.from_dictionary)

        # Perform the API call through the SDK function
        result = self.controller.create_send_rfc_1123_date_time_array_in_body_as_model(data)
