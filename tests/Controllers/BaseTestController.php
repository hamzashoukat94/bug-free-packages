...
use TestForDatetimeInModelLib\TestForDatetimeInModelClient;
use TestForDatetimeInModelLib\Tests\ClientFactory;
...
class BaseTestController extends TestCase
{
    ...
    protected static function getClient(): TestForDatetimeInModelClient
    {
