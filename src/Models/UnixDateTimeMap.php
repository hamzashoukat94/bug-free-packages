...
class UnixDateTimeMap implements \JsonSerializable
{
    /**
     ...
     * @required
     * @maps dateTime
     * @factory \TestForDatetimeInModelLib\Utils\DateTimeHelper::fromUnixTimestampMap
     *
     * @param array<string,\DateTime> $dateTime
     */
    ...
    {
        $json = [];
        $json['dateTime'] = DateTimeHelper::toUnixTimestampArray($this->dateTime);
