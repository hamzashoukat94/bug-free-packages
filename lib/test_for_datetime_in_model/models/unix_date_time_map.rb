...
module TestForDatetimeInModel
  # UnixDateTimeMap Model.
  class UnixDateTimeMap < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      unless hash['dateTime'].nil?
        ...
        hash['dateTime'].each do |key, datetime_string|
          date_time[key] = DateTimeHelper.from_unix(datetime_string)
        end
      end
      ...
      UnixDateTimeMap.new(date_time)
    end

    def to_date_time(hash, key)
      DateTimeHelper.to_unix_map(date_time, hash, key)
    end
  end
end
