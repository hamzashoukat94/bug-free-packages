...
module TestForDatetimeInModel
  # Rfc1123DateTimeMap Model.
  class Rfc1123DateTimeMap < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      unless hash['dateTime'].nil?
        ...
        hash['dateTime'].each do |key, datetime_string|
          date_time[key] = DateTimeHelper.from_rfc1123(datetime_string)
        end
      end
      ...
      Rfc1123DateTimeMap.new(date_time)
    end

    def to_date_time(hash, key)
      DateTimeHelper.to_rfc1123_map(date_time, hash, key)
    end
  end
end
